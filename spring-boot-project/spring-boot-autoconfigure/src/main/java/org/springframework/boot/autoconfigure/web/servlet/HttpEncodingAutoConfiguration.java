...
//启动指定类的ConfigurationProperties 功能，将配置文件中对应的值和HttpEncodingProperties绑定起来
@EnableConfigurationProperties(HttpProperties.class)

//Spring底层@Conditional注解，根据不同的条件，如果满足条件，整个配置类里面的配置就会生效
//判断当前应用是否是web应用，如果是，当前配置生效。并把HttpEncodingProperties加入到 Ioc容器中
...
public class HttpEncodingAutoConfiguration {
	...
	//给容器添加一个组件，这个组件中的某些值需要从properties中获取
	@Bean
	//判断容器中有没有这个组件
